...
| [AI_NATIVE_PIPELINE.md](AI_NATIVE_PIPELINE.md) | _(Vision)_ Four intertwined shifts: templates as the unit of choice (WeatherV1 as the inaugural template), agentic pipeline, AI-native (tools over JSON), and the "WeatherV1 → V1 AI Portal" rename. Industry best practices, design tensions, open questions. |
