...
- [ ] Step 4 — Electron-main FFmpeg verify
- [ ] Step 5 — Electron main/preload/server-manager + prepare-standalone
- [ ] Step 6 — Forge packaging
